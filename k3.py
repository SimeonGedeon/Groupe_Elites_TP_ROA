...
# Cas de test : graphe complet K3
# ============================================

# Graphe complet K3 : chaque sommet est voisin des deux autres
RAW_GRAPH = {
    "A": ["B", "C"],
    "B": ["A", "C"],
    "C": ["A", "B"],
...
# Palette de couleurs
COLOR_PALETTE = ["#ef476f", "#118ab2", "#06d6a0", "#ffd166"]
...
def main():
    ...
    root = tk.Tk()
    root.title("Validation Welsh-Powell - Graphe complet K3")
    ...
    subtitle = tk.Label(
        root,
        text="Cas de test : graphe complet K3",
        font=("Arial", 11),
        bg="white",
        fg="#374151"
    )
    ...
    canvas = tk.Canvas(root, width=400, height=280, bg="#f8fafc", highlightthickness=1)
    canvas.pack(pady=12)
